...
import DealComponent from './DealComponents';
import './css/Home.css'
    ...
    <div>
      ...
      <main>
        ...
        <div className='deals'>
          ...
          <div className='items'>
            <DealComponent 
            imageUrl={dealExample.imageUrl} 
            name={dealExample.name}
              price={dealExample.price}
              tiket={dealExample.tiket}
              yieldData={dealExample.yield}
              days={dealExample.days}
              sold={dealExample.sold}/>
